...
This header file will include the functionality used to assist in various program tasks like 
getting current time, logging errors, and hiding the command console
