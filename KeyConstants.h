...
class KeyPair 
{
	...
	*/
	...
	public:
		...
		KeyPair(const std::string &virtualKey = "", const std::string &humanName = "")
			: virtualKeyName(virtualKey), humanReadableName(humanName) {};
...
class KeyMap
{
	...
	*/
	...
	public:
        ...
        static std::map<int, KeyPair> KeyLookupEN;
